...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="calibrationcurve"),
        "USER": config("DB_USER", default="calibrationcurve"),
        "PASSWORD": config("DB_PASSWORD", default="calibrationcurve"),
